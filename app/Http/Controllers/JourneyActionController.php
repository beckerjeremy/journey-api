...
class JourneyActionController extends Controller
{
    ...
    public function update(Request $request, $journey, $activity, $id)
    {
        ...
        if ($journey->journey_activities->contains($activity) && $activity->journey_actions->contains($journeyAction)) {
            ...
            if (isset($request->input_id) && $request->input_id != null) $journeyAction->input_id = $request->input_id;
            else if (isset($request->input_id) && $request->input_id == null && $journeyAction->input_id != null) $journeyAction->input()->dissociate();
            $journeyAction->save();
